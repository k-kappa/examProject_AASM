...
model_Q.load_weights("./checkpoints_new/project_3.2_CNN_NEW_Model_coinrun500episodes_20lvl_rewEPISODIC-withsteppenality_terzoround_restartepsilonwherestopped_0003LR.weights.h5")
...
###############################
title_save_weights = ("./checkpoints_new/project_3.2_CNN_NEW_Model_coinrun"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewEPISODIC-withsteppenality_quartoround_restartepsilonwherestopped_0003LR.weights.h5")
