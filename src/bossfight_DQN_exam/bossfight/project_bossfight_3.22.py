...
model_Q.load_weights("./checkpoints_new/project_3.22_CNN_NEW_Model_bossfight500episodes_20lvl_rewEPISODIC-nosteppenality_terzoround_restartepsilonwherestopped_0003LR.weights.h5")
...
epsilon = 0.3#70  #prima era 70
discount_epsilon = 0.0003 #prima era 5
lower_bound_epsilon = 0.35  #prima era 20
###############################
title_save_weights = ("./checkpoints_new/project_3.22_CNN_NEW_Model_bossfight"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewEPISODIC-nosteppenality_quartoround_restartepsilonwherestopped_0003LR.weights.h5")
