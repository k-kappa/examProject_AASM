...
#model_Q.load_weights("./checkpoints/project_2.5_CNN_NEWPAPER_Model_GRAYSCALE-FRAMESTACKING-gradienttape_500episodes_15lvl_rewSTANDARD_esausto5_LBtepsilon_CLIPPING_0003LR.weights.h5")
...
###############################
title_save_weights = ("./checkpoints_new/project_3.3_CNN_NEWPAPER_Model_coinrun_GRAYSCALE-FRAMESTACKING-gradienttape_"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewSTANDARD_primoround_LBtepsilon_CLIPPING_0003LR.weights.h5")
...
for episode in range(number_episodes): #for each episode...
    ...
    for s in range(max_number_steps): #for each step...
        ...
        stacked_images_new = np.stack([obs_new[0], obs_new[1], obs_new[2]], axis=-1)
