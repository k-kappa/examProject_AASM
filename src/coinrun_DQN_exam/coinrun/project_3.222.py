...
model_Q.load_weights("./checkpoints_new/project_3.222_CNN_NEW_Model_coinrun500episodes_20lvl_rewPURETD(0)-nosteppenality_terzoround_restartepsilonwherestopped_0003LR.weights.h5")
...
epsilon = 0.35#70  #prima era 70
discount_epsilon = 0.0003 #prima era 5
lower_bound_epsilon = 0.30  #prima era 20
###############################
title_save_weights = ("./checkpoints_new/project_3.222_CNN_NEW_Model_coinrun"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewPURETD(0)-nosteppenality_quartoround_restartepsilonwherestopped_0003LR.weights.h5")
...
for episode in range(number_episodes): #for each episode...
    ...
    for s in range(max_number_steps): #for each step...
        ...
        #rew-= 0.1 #penality to find a shorter path
        ...
        if done:
            ...
            action_value_new=0 #beacuse this is the final step
