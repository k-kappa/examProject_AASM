...
model_Q.load_weights("./checkpoints_new/project_3.3_CNN_NEWPAPER_Model_chaser_GRAYSCALE-gradienttape_500episodes_20lvl_rewRealStandard_primo(BATCH64)round_DifferentNetworkMedium_0001LR.weights.h5")
...
epsilon = 0.50  #prima era 70
discount_epsilon = 0.0003 #prima era 5
lower_bound_epsilon = 0.3#.40  #prima era 20
###############################
title_save_weights = ("./checkpoints_new/project_3.3_CNN_NEWPAPER_Model_chaser_GRAYSCALE-gradienttape_"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewRealStandard_secondo(BATCH64)round_DifferentNetworkMedium_0001LR.weights.h5")
...
for episode in range(number_episodes): #for each episode...
    ...
    for s in range(max_number_steps): #for each step...
        ...
        #temporary_buffer.append(transition)  #no reward backpropagation
        ...
        if done:
            ...
            print(info['prev_level_complete'])
                ...
                #average_rew-=20
            '''for x in temporary_buffer:  #no reward backpropagation
