...
env = gym.make('procgen-coinrun-v0', 
                render_mode="human",
                num_levels=numbers_lvls, start_level=20, 
...
model_Critic.load_weights("./checkpoints_new/project_4.0_CNN_NEW_SMALL_Model_coinrun_ACTORCRITIC_100episodes_20lvl_rewEPISODIC(1-1)-nosteppenality_quartoround_restartepsilon_000001LR_CRITIC.weights.h5")
model_Actor.load_weights("./checkpoints_new/project_4.0_CNN_NEW_SMALL_Model_coinrun_ACTORCRITIC_100episodes_20lvl_rewEPISODIC(1-1)-nosteppenality_quartoround_restartepsilon_000001LR_ACTOR.weights.h5")
...
+str(numbers_lvls)+"lvl_rewEPISODIC(1-1)-nosteppenality_primoround_restartepsilon_00001LR")
