...
model_Critic.load_weights("./checkpoints_new/project_4.0_CNN_NEW_SMALL_Model_starpilot_ACTORCRITIC_500episodes_20lvl_rewEPISODIC(1-1)-nosteppenality_DYNAMIC_sestoround_restartepsilon_00005LR_CRITIC.weights.h5")
model_Actor.load_weights("./checkpoints_new/project_4.0_CNN_NEW_SMALL_Model_starpilot_ACTORCRITIC_500episodes_20lvl_rewEPISODIC(1-1)-nosteppenality_DYNAMIC_sestoround_restartepsilon_00005LR_ACTOR.weights.h5")
...
###############################
title_save_weights = ("./checkpoints_new/project_4.0_CNN_NEW_SMALL_Model_starpilot_ACTORCRITIC_"
+str(number_episodes)+"episodes_"
+str(numbers_lvls)+"lvl_rewEPISODIC(1-1)-nosteppenality_DYNAMIC_settimoround_restartepsilon_00005LR")
