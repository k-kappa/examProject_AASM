...
#model_Q.load_weights("./checkpoints_new/project_3.3_CNN_NEWPAPER_Model_starpilot_GRAYSCALE-FRAMESTACKING-gradienttape_2000episodes_20lvl_rewSTANDARD_sestoround_epsilon_CLIPPING_0003LR.weights.h5")
...
+str(numbers_lvls)+"lvl_rewSTANDARD_primoround_epsilon_CLIPPING_TD(0)_newTinyNetwork_0003LR.weights.h5")
...
for episode in range(number_episodes): #for each episode...
    ...
    for s in range(max_number_steps): #for each step...
        ...
        stacked_images = stacked_images_new
